...
var helpText = [][3]string{
	...
	{"", "enter", "start an agent with the chosen agent/repo/project, in the background"},
	{"", "", "the panel stays where it is; select the new card when you want to watch it"},
